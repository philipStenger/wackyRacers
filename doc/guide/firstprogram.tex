...
Before reading this chapter, make sure you have read the sections
relevant to your operating system in the
\hyperref[software]{toolchain chapter} (chapter~\ref{software}) first.
